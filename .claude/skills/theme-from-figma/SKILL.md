...
(DTCG document → theme YAML, Helix-standard fallbacks flagged with
...
- Never write outside `clients/<id>/` (the converter's Helix-standard
  fallbacks come from reading `themes/helix.yaml`, not editing it).
