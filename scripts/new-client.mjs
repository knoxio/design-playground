 ...
 * so it can be unit-tested; the CLI writes it, copying the Design standard theme
...
const HOME_PAGE = `import type { PageMeta } from "@design/ui";
 ...
 * `themeYaml` is the default theme to seed (the Design standard or a fork).
 */
...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
  ...
  const themeYaml = readFileSync(path.join(REPO_ROOT, "themes/design.yaml"), "utf8");
