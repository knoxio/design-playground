 ...
 * route prefix, or display name, plus data-hx-source. Exits non-zero on any
...
function leaksIn(scopedId) {
  ...
  const markers = [
    ...
    { label: "inspect source stamp", needle: 'data-hx-source":' },
...
for (const client of clients) {
  execSync("pnpm --filter @helix/app build", {
    cwd: repoRoot,
