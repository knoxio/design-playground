...
export function ViewportFrame({
  ...
  useEffect(() => {
    const onMessage = (e: MessageEvent) => {
      ...
      if (data.hx === "open-count") onOpenCount(data.count);
      if (data.hx === "exit-comments") onExitComments();
      if (data.hx === "ready") postToFrame({ hx: "comments-active", active: commentsActive });
    };
  ...
  useEffect(() => {
    postToFrame({ hx: "comments-active", active: commentsActive });
  }, [commentsActive]);
