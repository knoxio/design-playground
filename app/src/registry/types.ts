import type { PlayTest, TokenSet } from "@helix/ui";
import type { ComponentType } from "react";

/** Sentinel theme id for the Helix standard tokens ("::" cannot occur in filenames). */
export const HELIX_STANDARD_THEME = "::helix";
