...
The Helix Playground is a Vite + React app that wraps thin tooling around Claude
...
| [`guides/`](guides/)                               | How to use it: `getting-started`, `for-designers`, `for-developers`.             |
